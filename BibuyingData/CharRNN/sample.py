...
tf.flags.DEFINE_string('converter_path', 'model/jay/converter.pkl', 'model/name/converter.pkl')
tf.flags.DEFINE_string('checkpoint_path', 'model/jay', 'checkpoint path')
tf.flags.DEFINE_string('start_string', '源仔', 'use this string to start generating')
